...
print("Hello, world!")
image = Image.open("C:\\Users\\userHu\\Pictures\\Saved Pictures\\test2_5.png")#条纹图
...
lpantone=["default",'18-3927 TCX','18-3927 TCX','19-3926 TCX','17-3817 TCX','12-0000 TCX','16-3307 TCX','xx-xxxxTPX'] #色卡序号，default和xx不打印，用于检查是否出错
...
imageOrignal = Image.open("C:\\Users\\userHu\\Pictures\\Saved Pictures\\test2_5.png")#蒙版图
...
#for i in range(1,len(lr)):
    #if i!=5:
    #draw2.rectangle((xposition,2160,xposition+200,2160+180),(lr[i],lg[i],lb[i]),'black')#300/500
    #print(lr[i],lg[i],lb[i])#300/500#需要知道RGB值时使用
